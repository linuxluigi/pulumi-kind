...
1. Run the following command to update files to use the name of your provider (third-party: use your GitHub organization/username):
   ...
   - find and replace all instances of the boilerplate `kind` with the `NAME` of your provider.
...
- binary: pulumi-resource-kind
  ...
  ignore: []
  ldflags:
  - -X github.com/pulumi/pulumi-kind/provider/pkg/version.Version={{.Tag}}
  main: ./cmd/pulumi-resource-kind/
  sort: asc
  use: git
release:
  disable: false
...
├── config.yaml
├── metadata.json
├── pulumi-kind_darwin_amd64_v1
│   └── pulumi-resource-kind
├── pulumi-kind_darwin_arm64
│   └── pulumi-resource-kind
├── pulumi-kind_linux_amd64_v1
│   └── pulumi-resource-kind
├── pulumi-kind_linux_arm64
│   └── pulumi-resource-kind
├── pulumi-kind_windows_amd64_v1
│   └── pulumi-resource-kind.exe
└── pulumi-kind_windows_arm64
    └── pulumi-resource-kind.exe
```
